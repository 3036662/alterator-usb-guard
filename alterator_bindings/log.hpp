...
class Log {
   public:
    class Debug {
       public:
        template <typename T>
        const Debug &operator<<(const T &val) const noexcept {
            std::cerr << val;
            return *this;
        }
    ...
    class Info {
       public:
        template <typename T>
        const Info &operator<<(const T &val) const noexcept {
            std::cerr << val;
            return *this;
        }
    ...
    class Error {
       public:
        template <typename T>
        const Error &operator<<(const T &val) const noexcept {
            std::cerr << val;
            return *this;
        }
    ...
    class Test {
       public:
        template <typename T>
        const Test &operator<<(const T &val) const noexcept {
            std::cerr << val;
            return *this;
        }
